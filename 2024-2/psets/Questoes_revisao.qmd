...
**A resolução desta lista vale até 10% da nota do semestre.**
...
a. Mostre que se pelo menos uma das variáveis tem valor esperado igual a zero, então a covariância entre $X$ e $Y$ é dada por $\text{Cov}(X,Y) = E[XY]$.
...
$Y_i=\beta X_i + u_i$, $i=1,2,\ldots,n$ com amostra _iid_ e o termo de erro $u_i$ é tal que $E[u_i|X_i]=0$ e $\text{Var}(u_i|X_i)=\sigma^2$.
