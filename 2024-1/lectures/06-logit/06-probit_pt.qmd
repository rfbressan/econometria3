...
mroz %<>%
  ...
  mutate(
    age_fct = cut(age, breaks = 3, labels = FALSE),
...
.right-thin[
.center[![](https://media.giphy.com/media/111ebonMs90YLu/giphy.gif)]
]
...
| <a href="https://raw.githack.com/rfbressan/econometria3_slides/master/lectures/02-probit/lista_I_pt.html">.ScPored[<i class="fa fa-list fa-fw"></i>] | Lista de Exercícios I |
